...
public class tier3_Talent3 : MonoBehaviour 
{
	//Define Variables:
	CanvasGroup cg;
	public Tooltip_Reaver_Talent tooltip_Reaver_Talent;	//Provides direct access to the ToolTip_Mace script.
	...
	{
		// Show Tooltip
		tooltip_Reaver_Talent.show_Tooltip();
	...
	{
		// Hide Tooltip
		tooltip_Reaver_Talent.hide_Tooltip();
