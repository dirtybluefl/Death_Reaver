...
public class tier1_Talent3 : MonoBehaviour 
{
	//Define Variables:
	CanvasGroup cg;
	public Tooltip_Might_Talent tooltip_Might_Talent;	//Provides direct access to the ToolTip_Mace script.
	...
	{
		tooltip_Might_Talent.show_Tooltip();
	}
	...
	{
		tooltip_Might_Talent.hide_Tooltip();
	}
