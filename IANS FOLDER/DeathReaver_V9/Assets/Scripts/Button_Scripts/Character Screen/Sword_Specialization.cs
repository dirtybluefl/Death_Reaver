...
public class Sword_Specialization : MonoBehaviour 
{
	//Define Variables:
	CanvasGroup cg;
	public Tooltip_Sword tooltip_Sword;	//Provides direct access to the ToolTip_Mace script.
	...
	public void MouseClick()
	{
		...
		Player2.weapon_Specialization = 2;
