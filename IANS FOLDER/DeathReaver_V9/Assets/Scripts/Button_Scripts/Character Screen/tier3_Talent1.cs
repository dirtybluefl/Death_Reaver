...
public class tier3_Talent1 : MonoBehaviour 
{
	//Define Variables:
	CanvasGroup cg;
	public Tooltip_Unbreakable_Talent tooltip_Unbreakable_Talent;	//Provides direct access to the ToolTip_Mace script.
	...
	{
		// Show Tooltip
		tooltip_Unbreakable_Talent.show_Tooltip();
	...
	{
		// Hide Tooltip
		tooltip_Unbreakable_Talent.hide_Tooltip();
